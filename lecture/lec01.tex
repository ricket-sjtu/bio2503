...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Take-home Practical Final: 15\%
        \item Projects: 20\%
    \end{itemize}
    ...
    \item \textbf{Webpage}: \url{https://oc.sjtu.edu.cn/courses/88550}
	 \item \textbf{Github}: \url{https://github.com/ricket-sjtu/bio2503}
\end{itemize}
\end{frame}
...
\begin{itemize}
	...
	\item Lecture 04: Regular Expression - \textcolor{red}{grep, sed and awk}
...
\begin{itemize}
    ...
    \item Title: lab1\_5230809010
    \item Attachment: lab1\_5230809010.tar.gz
    \item \textbf{Late Policy}
    \begin{itemize}
        \item Solutions to assignments should be submitted before the due.
        \item Being late within 3 days will get the 80\% grades.
...
\Large Now start Linux and log in as the sudoer ``bio''; and then open a 
