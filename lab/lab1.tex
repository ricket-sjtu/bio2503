...
\begin{enumerate}[(1)]
	\item 以bio用户登录，在家目录下创建目录\lstinline{~/course/bio2503/lab1}。
		以后所有的上机工作都放在\lstinline{~/course/bio2503}下。
...
int main(){
	...
	\item 从搜索引擎获取关于\texttt{bioinformatics}在wikipedia上的页面，将其源码
		...
		bioinformatics的字符，把bioinformatics替换为biological data science
	\item 将当前\lstinline{bioinformatics}文件所属的用户修改为abc，组为bio，写出命令。
